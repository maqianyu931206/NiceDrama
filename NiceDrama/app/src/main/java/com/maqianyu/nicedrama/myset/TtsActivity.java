...
import com.maqianyu.nicedrama.myset.speech.setting.TtsSettings;
...
public class TtsActivity extends AbsActivity implements OnClickListener {
    ...
    protected void initViews() {
        startBtn = byView(R.id.tts_play);
        stopBtn = byView(R.id.tts_pause);
    ...
    protected void initDatas() {
        ...
        personSelect.setOnClickListener(this);
        // 初始化合成对象
